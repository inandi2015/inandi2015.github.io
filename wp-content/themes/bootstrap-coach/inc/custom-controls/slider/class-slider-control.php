...
if ( ! class_exists( 'Bootstrap_Coach_Slider_Control' ) ) {

	/**
	 * Slider control (range).
	 */
	class Bootstrap_Coach_Slider_Control extends Wp_Customize_Control {
        ...
        public function enqueue() {            
            wp_enqueue_style( 'travel-agency-bookinh-slider', get_template_directory_uri() . '/inc/custom-controls/slider/slider.css', null );
            wp_enqueue_script( 'travel-agency-bookinh-slider', get_template_directory_uri() . '/inc/custom-controls/slider/slider.js', array( 'jquery' ), false, true ); //for slider                
        }
